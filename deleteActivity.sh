...
PGPASSWORD=iqNFrdrffHXrcceCkDunnK1yfkyIaOOL psql -v workoutid=$wid -v updateDate=$updateDate -h dpg-ch1fcrceoogo6oihajeg-a.oregon-postgres.render.com -U fli myruns_en73  << FF
